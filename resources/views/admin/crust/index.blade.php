                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex mb-2">
                                <h3 class="me-auto">Total {{ count($crusts) }} Pizza crusts </h3>
                                                    ...
                                                    <div class="font-sans-serif btn-reveal-trigger">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                                            <a class="dropdown-item "
                                                                href="{{ route('crust.edit', $crust->pcrust_slug) }}">
                                                            ...
                                                            <a class="dropdown-item text-dark"
                                                                href="{{ route('crust.status', $crust->pcrust_slug) }}">
                                                                {{ $crust->pcrust_status == 1 ? 'Enable' : 'Disable' }}
                                                            </a>
                                                            <a class="dropdown-item text-dark"
                                                                href="{{ route('crust.publish', $crust->pcrust_slug) }}">
                                                                {{ $crust->pcrust_publish == 1 ? 'publish' : 'unpublish' }}
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
