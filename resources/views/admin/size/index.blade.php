                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex mb-2">
                                <h3 class="me-auto">Total {{ count($sizes) }} Pizza size </h3>
                                <a title="" href="{{ route('size.create') }}" class="btn btn-sm btn-secondary">
                        ...
                        <div class="card-body">
                            <div id="tableExample2"
                                ...
                                <div class="table-responsive scrollbar">
                                    <table class="table table-striped table-sm fs--1 mb-0">
                                        ...
                                        <tbody class="list">
                                            ...
                                            <tr>
                                                <td class="align-middle name">{{ $size->psize_title }}</td>
                                                <td class="align-middle price">{{ $size->psize_price }}</td>
                                                <td class="align-middle order">{{ $size->psize_order }}</td>
                                                <td class="align-middle status">
                                                    @if ($size->psize_publish == 1)
                                                    <div class="badge bg-success">publish</div>
                                                    @else
                                                    <div class="badge bg-danger">unpublish</div>
                                                    @endif
                                                </td>
                                                <td class="align-middle status">
                                                    @if ($size->psize_status == 1)
                                                ...
                                                <td class="align-middle white-space-nowrap text-end pe-0">
                                                    <div class="font-sans-serif btn-reveal-trigger">
                                                        <button class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs--2 bg-primary"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                                            <a class="dropdown-item "
                                                                href="{{ route('size.edit', $size->psize_slug) }}">
                                                                <span data-feather="edit"></span>Edit
                                                            </a>
                                                            <a id="delete" class="dropdown-item"
                                                                href="{{ route('size.destroy', $size->psize_slug) }}">
                                                                <span data-feather="trash"></span>Delete
                                                            </a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item text-dark"
                                                                href="{{ route('size.status', $size->psize_slug) }}">
                                                                {{ $size->psize_status == 1 ? 'Enable' : 'Disable' }}
                                                            </a>
                                                            <a class="dropdown-item text-dark"
                                                                href="{{ route('size.publish', $size->psize_slug) }}">
                                                                {{ $size->psize_publish == 0 ? 'publish' : 'unpublish' }}
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
                                ...
                                <div class="d-flex justify-content-center mt-3"><button class="page-link disabled"
