                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                              <div class="contact-form">
                                 ...
                                 <div role="form" class="wpcf7" id="wpcf7-f425-o1" lang="en-US" dir="ltr">
                                    ...
                                    <form method="POST" action="{{ route('website.contact.submit') }}" enctype="multipart/form-data">
                                        @csrf
                                       ...
                                       <div class="form-group row">
                                          <div class="col-xs-12 col-md-6">
                                             ...
                                             <input type="text" name="first_name" value="" size="40" class="form-control @error('first_name') is-invalid @enderror wpcf7-form-control wpcf7-text wpcf7-validates-as-required input-text" aria-required="true" aria-invalid="false" />
                                               @error('first_name')
                                          ...
                                          <div class="col-xs-12 col-md-6">
                                             ...
                                             <input type="text" name="last_name" value="" size="40" class="form-control @error('first_name') is-invalid @enderror   wpcf7-form-control wpcf7-text wpcf7-validates-as-required input-text" aria-required="true" aria-invalid="false" />
                                             @error('last_name')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                             </span>
                     ...
                     <div class="kc-css-194963 kc_col-sm-12 kc_column kc_col-sm-12">
                        <div class="stretch-full-width kc-col-container">
                           <div class="kc-css-126640 kc_shortcode kc_wrap_instagram  kc_ins_col_6">
                              <ul class="row">
                                  <li class="col-md-2 col-sm-2 col-lg-2 col-xs-4"><a href="https://www.instagram.com/p/BO4Gyf2hTkr/" target="_blank"><img alt="" src="{{asset('contents/website')}}/assets/images/footer/1.jpg"></a></li>
                                  <li class="col-md-2 col-sm-2 col-lg-2 col-xs-4"><a href="https://www.instagram.com/p/BO4Gtf1BCmM/" target="_blank"><img alt="" src="{{asset('contents/website')}}/assets/images/footer/2.jpg"></a></li>
                                  <li class="col-md-2 col-sm-2 col-lg-2 col-xs-4"><a href="https://www.instagram.com/p/BO4GnvhBqNt/" target="_blank"><img alt="" src="{{asset('contents/website')}}/assets/images/footer/3.jpg"></a></li>
                                  <li class="col-md-2 col-sm-2 col-lg-2 col-xs-4"><a href="https://www.instagram.com/p/BO4GhsuhQE4/" target="_blank"><img alt="" src="{{asset('contents/website')}}/assets/images/footer/4.jpg"></a></li>
                                  <li class="col-md-2 col-sm-2 col-lg-2 col-xs-4"><a href="https://www.instagram.com/p/BO4F_ZbBuxI/" target="_blank"><img alt="" src="{{asset('contents/website')}}/assets/images/footer/5.jpg"></a></li>
                                  <li class="col-md-2 col-sm-2 col-lg-2 col-xs-4"><a href="https://www.instagram.com/p/BO4F8fLhgkp/" target="_blank"><img alt="" src="{{asset('contents/website')}}/assets/images/footer/6.jpg"></a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
