                  ...
                  <div class="header-info-wrapper">
                     <div class="header-phone-numbers">
                        ...
                        <select class="select-city-phone-numbers" name="city-phone-numbers" id="city-phone-numbers">
                           <option value="54 548 779 654">Dhanmondi</option>
                           <option value="33 398 621 710">Mirpur</option>
                           <option value="718 54 674 021">Tejgaon</option>
                        </select>
                        <span id="city-phone-number-label" class="phone-number">0183 506 1968</span>
                     </div>
